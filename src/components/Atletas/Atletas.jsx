        ...
        <section id="atletas" className={styles.atletasSection} ref={sectionRef}>
            ...
            <div className={styles.cardsContainer} ref={cardsRef}>
                {athletesData.map((athlete, index) => (
                    ...
                    >
                        {/* Background Icon */}
                        <img src={iconBackground} alt="" className={styles.cardBgIcon} loading="lazy" decoding="async" />

                        {/* Player Image - Lowered via CSS */}
                        <img src={athlete.image} alt={athlete.name} className={styles.cardImage} loading="lazy" decoding="async" />
